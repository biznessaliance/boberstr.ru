...
Webflow.require('ix').init([
  {"slug":"body-load","name":"Body load","value":{"style":{"opacity":0},"triggers":[{"type":"load","stepsA":[{"opacity":1,"transition":"opacity 1000ms ease 0"}],"stepsB":[]}]}},
  {"slug":"open-lbox","name":"open lbox","value":{"style":{},"triggers":[{"type":"click","selector":".lbox","stepsA":[{"opacity":0},{"display":"block","opacity":1,"transition":"opacity 1000ms ease 0"}],"stepsB":[]}]}},
  {"slug":"close-all-lbox","name":"Close all Lbox","value":{"style":{},"triggers":[{"type":"click","selector":".lbox","stepsA":[{"opacity":0,"transition":"opacity 1000ms ease 0"},{"display":"none"}],"stepsB":[]}]}}
]);
